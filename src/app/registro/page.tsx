  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-white relative">
      ...
      <div
        ...
        style={{ backgroundImage: 'url("/imagenes/IACMM.png")', backgroundSize: 'cover', backgroundPosition: 'center', backgroundAttachment: 'fixed' }}
      ></div>

<div
    className="absolute flex justify-center opacity-100"
    style={{
      top: '12%', // Cambia este valor para moverla hacia arriba o hacia abajo
    }}
  >
    <img
  ...
  <a href="#" className="text-[#EA95C4] hover:text-[#EA95C4]/80">Iniciar Sesión</a>
        ...
        {success && (
          <p className="text-center text-green-500 mt-4">Su solicitud está siendo verificada.</p>
        )}
        {error && (
          <p className="text-center text-red-500 mt-4">Error: {error}</p>
        )}
        {status === "Aceptado" && (
          <p className="text-center text-green-500 mt-4">¡Su solicitud ha sido aceptada! Ya puede ingresar.</p>
        )}
        {status === "Denegado" && (
          <p className="text-center text-red-500 mt-4">Su solicitud ha sido denegada.</p>
        )}
        ...
        <form onSubmit={handleSignup} className="mt-6 space-y-5">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label htmlFor="fullName" className="block text-sm font-semibold mb-1">Nombre y Apellido</label>
              <input
                type="text"
                id="fullName"
                value={fullName}
            ...
            <div>
              <label htmlFor="phone" className="block text-sm font-semibold mb-1">Celular</label>
              <input
                type="tel"
                id="phone"
                value={phone}
          ...
          <div>
            <label htmlFor="hospital" className="block text-sm font-semibold mb-1">Hospital / Institución</label>
            <input
              type="text"
              id="hospital"
              value={hospital}
